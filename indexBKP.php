...
<head>
	...
	<meta name="keywords" content="poiema, poiemeiros, poiema music, summer, stream, carnaval, festa, celebração, igreja, ministros, março, cidade, taubaté, vale do paraíba, vale, verão, jesus">
			...
			<div class="row">
				<div class="col-12 video-display">
						...
						<form action="">
							<div class="row">
								<div class="col-sm-12 col-md-*  text-center">
									...
									<p>Por favor, preencha com seu email para assistir</p>
								</div>
							</div>
							<div class="row mt-2">
					...
					<div class="embed-responsive embed-responsive-16by9">
						<iframe id="poiemastreamframe" src="<?php echo $Links["Stream"]; ?>" frameborder="0" allowfullscreen></iframe>
					</div>		
				</div>
			</div>
		</div>
